/**
 * Application shell (docs/spec/interaction.md layout): header, filter sidebar,
 * and the timeline workspace. Desktop-only. Loads the dataset once through
 * DataSource with a loading | error | ready state machine.
 */
