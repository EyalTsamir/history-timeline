...
- Single-page app, **no router**: the only navigable state is the timeline view, encoded in the URL hash (`#t=1948.35&s=12y&f=…`) so links are shareable and GH Pages needs no SPA-fallback tricks.
